...
//                   variant="ghost"
//                   className={cn(
//                     "w-full justify-start gap-3 h-11 text-white/70 hover:text-white hover:bg-[#013936]/50",
//                     isActive && "bg-[#C7E196] text-[#013936] hover:bg-[#C7E196]/90 hover:text-[#013936] font-semibold",
//                   )}
//                   onClick={() => {
//                     navigate(item.href);
