...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  //   console.log('🔐 PendingUser:', pendingUser); // ← ¿Existe?
  //   try {
  //     if (!pendingUser) {
  ...
  //     console.log('🔐 Respuesta del backend:', data); // ← ¿Token recibido?
  ...
  //       };
  //     }
  //     // ✅ VERIFICAR QUE EL TOKEN SE RECIBE
  //     if (!data.accessToken) {
  ...
  //     // Agrega esto justo antes del setTimeout
  ...
  //     // En el verifyEmailCode, después de guardar el usuario
  //     console.log('🔐 AuthContext - Usuario guardado, verificando contexto...');
  //     console.log('🔐 AuthContext - User state:', user); // Esto debería mostrar el usuario

  //     setTimeout(() => {
  //       console.log('🔐 Redirigiendo a rol:', data.rol);

  //       // ✅ VERSIÓN MEJORADA - Más clara y robusta
