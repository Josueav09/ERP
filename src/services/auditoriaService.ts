...
// // ✅ INTERFACES ACTUALIZADAS según tu BD
...
//     try {
//       console.log('🔄 [auditoriaService] Obteniendo auditoría con filters:', filters);
...
//       const url = `/jefe/auditoria/contratos?${params.toString()}`;
//       console.log('📞 [auditoriaService] Llamando a:', url);
      
//       const data = await apiService.get(url);
//       console.log('✅ [auditoriaService] Datos recibidos:', data || 0, 'registros');
...
//       const data:AuditoriaStats = await apiService.get('/jefe/auditoria/estadisticas');
//       console.log('✅ [auditoriaService] Estadísticas recibidas');
//       return data;
//     } catch (error) {
...
//       const data = await apiService.get('/jefe/auditoria/resumen-mensual');
...
//       console.warn('⚠️ [auditoriaService] Datos de auditoría inválidos:', dbAuditoria);
//       return [];
//     }
...
//       // Mapear nombres desde las relaciones
//       empresa_nombre: audit.empresa || audit.empresa_proveedora?.razon_social,
//       cliente_nombre: audit.cliente || audit.cliente_final?.razon_social,
//       ejecutiva_nombre: audit.ejecutiva || audit.ejecutiva?.nombre_completo,
//       ejecutiva_anterior_nombre: audit.ejecutiva_anterior || audit.ejecutiva_anterior?.nombre_completo,
//       ejecutiva_nueva_nombre: audit.ejecutiva_nueva || audit.ejecutiva_nueva?.nombre_completo
//     }));
//   },
...
//   // Método para formatear fecha de manera consistente
